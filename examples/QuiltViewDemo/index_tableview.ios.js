...
class Example1 extends React.Component {
    ...
    render() {
        return (
            <QuiltView style={{flex:1}} onPress={(event) => alert(JSON.stringify(event))}>
...
class Example2 extends React.Component {
    ...
    render() {
        var country = "ES";
        return (
            <QuiltView selectedValue="" style={{flex:1}} json="states" filter={`country=='${country}'`}
    ...
    render(){
        return (
            <QuiltView style={{flex:1}}
                       tableViewStyle={QuiltView.Consts.Style.Grouped}
                       tableViewCellStyle={QuiltView.Consts.CellStyle.Subtitle}
                       onPress={(event) => alert(JSON.stringify(event))}>
    ...
    render(){
        ...
        return (
            <View style={{flex:1}}>
                ...
                <QuiltView style={{flex:1}} editing={this.state.editing}
